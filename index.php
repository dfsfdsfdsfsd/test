...
define('CAMPAIGN_ID', "8523678059969e9b9e2fbc4b253e4b2e");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'e2a83004be609210c0f5ad44a2e87fab');
define('MP_PARAM_NAME', '__ir_');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'c7eaf825cdb8c9330d541a8b40c62a9c');
define('CHECK_MCPROXY_VALUE', 'f83a0412b6aeb134ebc4fb4de270412c46093191b975253b3ad1399615affe54');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '6389.3');
